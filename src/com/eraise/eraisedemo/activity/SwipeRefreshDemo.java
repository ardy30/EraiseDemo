...
/**
 * v4包19.1添加的新控件，列表的下拉刷新，但是体验并不好
 */
public class SwipeRefreshDemo extends Activity implements OnRefreshListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        mSwipeRefreshWidget = (SwipeRefreshLayout) findViewById(R.id.srl);
